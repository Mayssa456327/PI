...
class SponsorController extends AbstractController
{
    ...
    #[Route('/new/{idEvent}', name: 'app_sponsor_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager, $idEvent): Response
    {
        ...
        if (!$event) {
            throw $this->createNotFoundException('Event not found for id ' . $idEvent);
        }
    
        $sponsor = new Sponsor();
        $sponsor->setEvenement($event);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_evenement_showF', ['id' => $idEvent], Response::HTTP_SEE_OTHER);        
        }
